...
--
-- Name: client_request; Type: TABLE; Schema: public; Owner: nastyxxaavs_user
--
...
ALTER TABLE public.client_request OWNER TO nastyxxaavs_user;
...
ALTER SEQUENCE public.client_request_id_seq OWNED BY public.client_request.id;
...
--
-- Name: form; Type: TABLE; Schema: public; Owner: nastyxxaavs_user
--
...
ALTER TABLE public.form OWNER TO nastyxxaavs_user;
...
--
-- Name: client_request id; Type: DEFAULT; Schema: public; Owner: nastyxxaavs_user
--

ALTER TABLE ONLY public.client_request ALTER COLUMN id SET DEFAULT nextval('public.client_request_id_seq'::regclass);
...
--
-- Name: form id; Type: DEFAULT; Schema: public; Owner: nastyxxaavs_user
--
...
--
-- Data for Name: client_request; Type: TABLE DATA; Schema: public; Owner: nastyxxaavs_user
--

COPY public.client_request (id, "clientName", "contactInfo", "requestDate", status, "firmId", "userId", "teamMemberId", "serviceId") FROM stdin;
\.
...
--
-- Data for Name: form; Type: TABLE DATA; Schema: public; Owner: nastyxxaavs_user
--

COPY public.form (id, name, email, "createdAt") FROM stdin;
\.
...
SELECT pg_catalog.setval('public.client_request_id_seq', 1, false);
...
--
-- Name: client_request client_request_pkey; Type: CONSTRAINT; Schema: public; Owner: nastyxxaavs_user
--
...
--
-- Name: form form_pkey; Type: CONSTRAINT; Schema: public; Owner: nastyxxaavs_user
--
...
--
-- Name: client_request client_request_firmId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: nastyxxaavs_user
--
...
--
-- Name: client_request client_request_serviceId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: nastyxxaavs_user
--
...
--
-- Name: client_request client_request_teamMemberId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: nastyxxaavs_user
--
...
--
-- Name: client_request client_request_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: nastyxxaavs_user
--

ALTER TABLE ONLY public.client_request
    ADD CONSTRAINT "client_request_userId_fkey" FOREIGN KEY ("userId") REFERENCES public."user"(id) ON DELETE CASCADE;
